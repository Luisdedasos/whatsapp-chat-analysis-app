...
st.write('Creado por Luis Romero que te quiere mucho hermosa')
###################################
###################################
...
###################################
###################################
st.header('Emojis más usados que no se usan ajjsja')
col1, col2 = st.columns([1, 2])
